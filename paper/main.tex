...
\toprule
$n$ & $\dim B^+$ & Predicted by $\binom{n+1}{2}$ & Predicted by $n-1$ & Computed & Status \\
\midrule
...
\bibitem{BNPP}
C.~Bendel, D.~Nakano, B.~Parshall, and C.~Pillen, \emph{Cohomology of quantum groups and finite groups of Lie type}, preprint, arXiv:1102.3639.

\bibitem{BL07}
R.~Bezrukavnikov and A.~Lachowska, \emph{On the center of the small quantum group}, preprint, arXiv:math/0609819.

\bibitem{Neg22}
C.~Negron, \emph{The half-quantum flag variety and representations for small quantum groups}, preprint, arXiv:2212.12198.

\bibitem{AS05}
N.~Andruskiewitsch and H.-J. Schneider, \emph{Pointed Hopf algebras}, in \emph{New Directions in Hopf Algebras}, MSRI Publ.\ 43, 2002; arXiv:math/0502157.

\bibitem{Ang10}
I.~Angiono, \emph{On Nichols algebras of diagonal type}, J.~Eur.~Math.~Soc.~\textbf{17} (2015), 1--48; arXiv:1008.4144.

\bibitem{MPSW}
M.~Mastnak, J.~Pevtsova, P.~Schauenburg, and S.~Witherspoon, \emph{Cohomology of finite-dimensional pointed Hopf algebras}, Proc.~Lond.~Math.~Soc.~\textbf{107} (2013), 737--768; arXiv:0902.0801.

\bibitem{Hec09}
M.~Heckenberger, \emph{Classification of arithmetic root systems}, Adv.~Math.~\textbf{220} (2009), 59--124.

\bibitem{Ang08}
I.~Angiono, \emph{On Nichols algebras with standard braiding}, J.~Algebra~\textbf{324} (2010), 1624--1658; arXiv:0804.0816.

\bibitem{LV21}
A.~Lachowska and R.~Voorhaar, \emph{On the derived center of small quantum groups}, preprint, arXiv:1912.08783.
